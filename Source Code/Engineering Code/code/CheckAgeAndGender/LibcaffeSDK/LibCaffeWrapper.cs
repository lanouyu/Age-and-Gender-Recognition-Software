...
namespace LibcaffeSDK
{
    ...
    public class LibCaffeWrapper
    {
        ...
        [DllImport("libcaffe.dll", EntryPoint = "AgeLoad", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int AgeLoad(string amodel_file, string atrained_file, string amean_file);

        [DllImport("libcaffe.dll", EntryPoint = "GenderLoad", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int GenderLoad(string gmodel_file, string gtrained_file, string gmean_file);

        [DllImport("libcaffe.dll", EntryPoint = "imageLoad", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int imageLoad(string image_file);

        [DllImport("libcaffe.dll", EntryPoint = "AgePre", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int AgePre(string image_file, ref PredictionInfo p);

        [DllImport("libcaffe.dll", EntryPoint = "GenderPre", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("libcaffe.dll", EntryPoint = "GenderPrediction", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("libcaffe.dll", EntryPoint = "AgeGenderPrediction", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("libcaffe.dll", EntryPoint = "add", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
        public static extern int add(int a, int b);
        [DllImport("libcaffe.dll", EntryPoint = "AgePrediction", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
